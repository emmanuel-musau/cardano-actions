...
| [0009](0009-error-taxonomy-and-versioning.md) | Classify failures by what a client does next, and version the protocol with a single integer per URL | Accepted |
